...
package org.wso2.identity.cdm.auth.listener.internal;
...
import org.wso2.identity.cdm.auth.listener.AuthEventListener;

/**
 * This class contains the implementation of the service component of the TenantAssociationManagement.
 */
@Component(
        name = "org.wso2.carbon.identity.cdm.auth.listener",
        immediate = true
)
